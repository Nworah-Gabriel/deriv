 ...
 */
export declare const OAuth2Logout: (options: OAuth2LogoutOptions) => Promise<void>;
/**
 ...
 *
 */
export declare const clearOIDCStorage: (options: ClearOIDCStorageOptions) => Promise<void>;
/**
